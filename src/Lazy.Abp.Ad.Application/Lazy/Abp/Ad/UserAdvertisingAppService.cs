...
namespace Lazy.Abp.Ad
{
        ...
        IUserAdvertisingAppService
    {
        ...
        public async override Task<UserAdvertisingDto> UpdateAsync(Guid id, UserAdvertisingCreateUpdateDto input)
        {
        ...
        public async override Task<PagedResultDto<UserAdvertisingDto>> GetListAsync(UserAdvertisingListInput input)
        {
